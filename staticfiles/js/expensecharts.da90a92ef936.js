...
const renderChart = (data, labels, title, backc, borc) => {
...
const getChartData = () => {
  ...
  fetch("/expense_summary")
    ...
    renderChart(data, labels, "Monthly Expense", "rgba(255, 99, 132, 0.2)","rgba(255, 99, 132, 1)");
    renderChart(y_labels, y_data,"Yearly Expense", "rgba(255, 99, 132, 0.2)","rgba(255, 99, 132, 1)");
